# [ESG-Data-Hub](https://www.davidsantossalvador.es/how-i-built-an-esg-data-hub-from-scratch)
...
Tired of reporting the same information, I have created an ESG Data Hub or ESG Dataverse for our corporation where I can search whenever I need any ESG KPIs for reporting. Data products that come from this app are 2:
...
- **Data Governance**: Every data system needs a Data governance system, so I trusted Open Metadata, hosted thanks to Docker locally.

This solution could be amazing for me, but for someone not a specialist, this information is just numbers. For this reason, 2 specialised agents are connected to the database: the Analyst Agent that queries all the data we need in SQL, and the ESG Specialist, which receives the query from the first one and interprets it to create a well-designed Executive Report.

<img width="1052" height="589" alt="Captura de pantalla 2026-04-24 a las 16 16 55" src="https://github.com/user-attachments/assets/8da65ed3-7c54-410c-864e-8bfe2536317c" />
...
This year started with the Sustainability Report, which was followed by TOP Employer certification and our Investor Due Dilligence report. After this journey, our corporation updates our Greenhouse Emissions Inventory (GEI). 
...
After analysing all the KPIs deeply, I was reporting in each Report, 80% of those it was the same; in other words, the 80% of the KPIs I was reporting were represented in every report 
...
So I defined I wanted to go further into this topic, so I analysed my digital toolkit: good analytics skills, nice Excel skills, good enough for Power BI skills, good at the Data Science field and starting into Data Engineer tools. 
...
<img width="1193" height="577" alt="Captura de pantalla 2026-04-24 a las 16 25 22" src="https://github.com/user-attachments/assets/14f6d16d-43d7-4bcb-a4db-6d6604e75dbf" />
...
Nice approach, we could argue, but the first problem emerged: if all our ESG Data is stored in our database, then that means someone should have known how to query it with SQL. 
...
- ESG Specialist who receives the data from our first agent and analyses it with ESG vision and critical thinking. The output from the agent is divided into 5 main tasks:
...
<img width="744" height="845" alt="Captura de pantalla 2026-04-24 163256" src="https://github.com/user-attachments/assets/b3c62624-c071-47b1-b437-e05492f9cba8" />
...
<img width="1802" height="744" alt="Pasted image 20260424122116" src="https://github.com/user-attachments/assets/159dab05-fcdb-4c8b-9522-33a2cfe07dde" />
